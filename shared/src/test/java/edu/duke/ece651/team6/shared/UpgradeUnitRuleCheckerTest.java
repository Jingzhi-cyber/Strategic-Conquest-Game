...
public class UpgradeUnitRuleCheckerTest {
    ...
    public void testBasicFunc() {
        ...
        UpgradeUnitRuleChecker upgradeUnitRuleChecker = new UpgradeUnitRuleChecker(null);
        upgradeUnitRuleChecker.checkMyRule(invalid1, gameMap);
        upgradeUnitRuleChecker.checkMyRule(valid, gameMap);
    }
}