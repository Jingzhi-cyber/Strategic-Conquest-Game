...
public class RiscMaster implements Master {
    ...
    public RiscMaster(int port, int playerNum) throws IOException {
        ...
        if (playerNum < 2 || playerNum > 4) {
            throw new IllegalArgumentException("player number needs to be between 2 - 4 but is " + Integer.toString(playerNum));
        }
    ...
    public boolean init() throws IOException {
         ...
         *  - Generate an unique player id to constuct a PlayerProfile, set the corresponding socket, update playerProfiles
         */
    ...
    public void prepare() {
         ...
         * Send GameBasicSetting including territories and total units available for placement to players
         */
    ...
    public boolean playOneTurn() throws IOException {
        ...
        /**
         * Receive commit from each player, check if that is valid (already checked in client side)
         * Execute the commits
         */
