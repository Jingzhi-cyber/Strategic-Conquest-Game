...
public class ClientTest {
  ...
  //   Socket getSocket(String localhost, int port) throws UnknownHostException, IOException {
  //     return new Socket(localhost, port);
  //   }

  //   Socket getSocket(InetAddress addr, int port) throws UnknownHostException, IOException {
